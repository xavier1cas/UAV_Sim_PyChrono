...
body_1.SetMass(1.619209834151024)
body_1.SetInertiaXX(chrono.ChVector3d(0.01225048804048794,0.01172646098023174,0.011707272348066684))
body_1.SetInertiaXY(chrono.ChVector3d(-8.416911654144621e-07,-0.0006349503545381315,-3.386541137169091e-06))
body_1.SetFrameCOMToRef(chrono.ChFramed(chrono.ChVector3d(0.007820715985121464,-0.018509771136826583,4.941918914074352e-05),chrono.ChQuaterniond(0,0,1,0)))

body_1_1_shape = chrono.ChVisualShapeModelFile()
body_1_1_shape.SetFilename(shapes_dir +'Total_Body_sub.obj')
body_1_1_shape.SetColor(chrono.ChColor(0.1, 0.1, 0.3))
...
mr[1,0]=0; mr[1,1]=0; mr[1,2]=-1; 
mr[2,0]=0; mr[2,1]=1; mr[2,2]=0; 
collshape = chrono.ChCollisionShapeBox(mat_1,0.23145987416302546,0.24489553447165766,0.09475000010000002)
body_1.GetCollisionModel().AddShape(collshape,chrono.ChFramed(chrono.ChVector3d(0.00727006291848727,0.014875000050000009,0.0), mr))
...
body_1.GetCollisionModel().AddShape(collshape,chrono.ChFramed(chrono.ChVector3d(0.0,-0.23514,0.0), mr))
...
body_2.SetPos(chrono.ChVector3d(-0.08785545399517353,0.035,-0.10844776723582882))
...
body_3.SetPos(chrono.ChVector3d(-0.08785545399517353,-0.022,-0.10844776723582882))
...
body_4.SetPos(chrono.ChVector3d(0.08785545399517353,-0.022,0.10844776723582882))
...
body_5.SetPos(chrono.ChVector3d(-0.08785545399517353,0.035,0.10844776723582882))
...
body_6.SetPos(chrono.ChVector3d(0.08785545399517353,0.035,-0.10844776723582882))
...
body_8.SetPos(chrono.ChVector3d(0.08785545399517353,0.035,0.10844776723582882))
...
body_9.SetPos(chrono.ChVector3d(0.08785545399517353,-0.022,-0.10844776723582882))
...
body_10.SetPos(chrono.ChVector3d(-0.08785545399517353,-0.022,0.10844776723582882))
...
marker_0_1.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(-0.08785545399517354,0.04300000000000001,-0.10844776723582883),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))

# Auxiliary marker (coordinate system feature)
marker_0_2 = chrono.ChMarker()
marker_0_2.SetName('Coordinate System5')
body_0.AddMarker(marker_0_2)
marker_0_2.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(-0.08785545399517353,-0.02999999999999999,-0.10844776723582883),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))

# Auxiliary marker (coordinate system feature)
marker_0_3 = chrono.ChMarker()
marker_0_3.SetName('Coordinate System2')
body_0.AddMarker(marker_0_3)
marker_0_3.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(0.08785545399517357,0.04300000000000001,-0.1084477672358288),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))

# Auxiliary marker (coordinate system feature)
marker_0_4 = chrono.ChMarker()
marker_0_4.SetName('Coordinate System6')
body_0.AddMarker(marker_0_4)
marker_0_4.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(0.08785545399517357,-0.02999999999999999,-0.10844776723582879),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))

# Auxiliary marker (coordinate system feature)
marker_0_5 = chrono.ChMarker()
marker_0_5.SetName('Coordinate System3')
body_0.AddMarker(marker_0_5)
marker_0_5.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(0.08785545399517357,0.043,0.1084477672358288),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))

# Auxiliary marker (coordinate system feature)
marker_0_6 = chrono.ChMarker()
marker_0_6.SetName('Coordinate System7')
body_0.AddMarker(marker_0_6)
marker_0_6.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(0.08785545399517357,-0.030000000000000006,0.1084477672358288),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))

# Auxiliary marker (coordinate system feature)
marker_0_7 = chrono.ChMarker()
marker_0_7.SetName('Coordinate System4')
body_0.AddMarker(marker_0_7)
marker_0_7.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(-0.08785545399517354,0.043,0.10844776723582883),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))

# Auxiliary marker (coordinate system feature)
marker_0_8 = chrono.ChMarker()
marker_0_8.SetName('Coordinate System8')
body_0.AddMarker(marker_0_8)
marker_0_8.ImposeAbsoluteTransform(chrono.ChFramed(chrono.ChVector3d(-0.08785545399517354,-0.030000000000000006,0.10844776723582883),chrono.ChQuaterniond(0.7071067811865476,-0.7071067811865476,0.0,0.0)))
