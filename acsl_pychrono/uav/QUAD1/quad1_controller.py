from acsl_pychrono.uav.QUAD1 import QUAD1
import numpy as np
import acsl_pychrono.uav as UAV_module

class QUAD1_Controller_Params:
  def __init__(self, uav: QUAD1):
    
    # UAV specific parameters
    cfg = UAV_module.get_uav_config("QUAD1") # Config Dictionary
