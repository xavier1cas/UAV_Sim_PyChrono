from acsl_pychrono.uav.THRUSTSTAND import THRUSTSTAND
import numpy as np
import acsl_pychrono.uav as UAV_module

class THRUSTSTAND_Controller_Params:
  def __init__(self, uav: THRUSTSTAND):
    
    # UAV specific parameters
    cfg = UAV_module.get_uav_config("THRUSTSTAND") # Config Dictionary
